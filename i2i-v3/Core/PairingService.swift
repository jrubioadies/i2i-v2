...
final class PairingService {
    ...
    func accept(_ payload: PairingPayload) throws {
        ...
        guard payload.encryptionPublicKey != nil else {
            throw PairingError.missingEncryptionKey
        }
        let peer = Peer(
            id: payload.deviceId,
    ...
    enum PairingError: Error, LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .missingEncryptionKey: return "This QR was generated by an older build. Update that device and generate a new QR."
            }
        }
    }
}
